...
static inline int CB(Cpu* cpu, Memory* memory)
{
	...
	switch(i)
	{
		...
		case 0x46: cc = 16; CBBITHL  (cpu, memory, 0);    break;
		...
		case 0x4E: cc = 16; CBBITHL  (cpu, memory, 1);    break;
		...
		case 0x56: cc = 16; CBBITHL  (cpu, memory, 2);    break;
		...
		case 0x5E: cc = 16; CBBITHL  (cpu, memory, 3);    break;
		...
		case 0x66: cc = 16; CBBITHL  (cpu, memory, 4);    break;
		...
		case 0x6E: cc = 16; CBBITHL  (cpu, memory, 5);    break;
		...
		case 0x76: cc = 16; CBBITHL  (cpu, memory, 6);    break;
		...
		case 0x7E: cc = 16; CBBITHL  (cpu, memory, 7);    break;
