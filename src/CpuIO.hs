...
-- Game Boy Emulator
--
-- This module does emulation of the Game Boy's Z80 like CPU, using
-- an alternative implementation that uses the IO monad and mutable
-- variables as an attempt to get good performance.
--
-----------------------------------------------------------------------------
